...
namespace publisher.Controllers
{
    ...
    public class pubsubClass : ControllerBase
    {
        ...
        public async void Publish(PubSubObject pubsub)
        {
            ...
            string dataJsonObject = Newtonsoft.Json.JsonConvert.SerializeObject(pubsub.data);
            await daprClient.PublishEventAsync<string>(pubsub.subscriber.pubsubname, pubsub.subscriber.topic, dataJsonObject);
